...
This add-on uses the awesomework of <https://github.com/ow/samsung-frame-art> . It adds the ability to place images in "Media" (it creates a specific directory for it under MyMedia called "frame" where you can place your images).
